...
- [ ] 1. Entry & cross-application navigation
  - [ ] 1.1 Default landing and app reachability
  ...
  - [ ] 1.2 Switch applications without a full reload
  ...
  - [ ] 1.3 Active app and section are indicated
  ...
  - [ ] 1.4 Deep-linking / direct addressability
    - **Preconditions:** None.
    - **Steps:**
  ...
  - [ ] 1.5 Browser back/forward integrity
...
- [ ] 2. Component coverage & states sanity
  - [ ] 2.1 No runtime/console errors while touring every screen
  ...
  - [ ] 2.2 Components appear in representative (non-empty) states
...
- [ ] 3. Console — dashboard
  - [ ] 3.1 Dashboard summarizes metrics and activity
  ...
  - [ ] 3.2 Visualizations are self-contained (no chart library)
...
- [ ] 4. Console — users (search / filter / sort / CRUD)
  - [ ] 4.1 Search filters across name and email
  ...
  - [ ] 4.4 Create a user — validation blocks invalid submit
...
- [ ] 5. Console — settings
  - [ ] 5.1 Preference controls reflect and change in session
...
- [ ] 6. Tracker — board, list, detail, CRUD, filters
  - [ ] 6.1 Board shows status columns
  ...
  - [ ] 6.2 Status change reflects immediately
  ...
  - [ ] 6.3 Open task detail without losing context
  ...
  - [ ] 6.4 Detail surface adapts to viewport
  ...
  - [ ] 6.5 Create / edit a task with validation and assignees
  ...
  - [ ] 6.6 List view and board/list toggle
...
- [ ] 7. Commerce — orders, products, customers
  - [ ] 7.1 Orders list with search / filter / sort
  ...
  - [ ] 7.2 Order detail with line items and computed total
  ...
  - [ ] 7.3 Product catalog as a visual gallery
  ...
  - [ ] 7.4 Create / edit a product with validation
  ...
  - [ ] 7.5 Product data change propagates to every view (R5.6)
  ...
  - [ ] 7.6 Price-range and category filters
    - **Preconditions:** On `/shop/products`.
    - **Steps:**
