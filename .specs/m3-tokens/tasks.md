...
- [x] 2. Create the color-token generator script
...
- [x] 3. Add the `generate-tokens` Nx target
...
- [x] 7. Author the reference + typography partials
...
- [x] 8. Author the shape, elevation, state, and motion partials
...
- [x] 9. Rewrite `theme.css` as a barrel
...
- [x] 13. Document the token contract
...
- [x] 14. Final checkpoint — everything green
